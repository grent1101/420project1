...
/**
 * Testing program for Part 0. By default, this reads from tests/test07-input.txt and
 * writes the output to tests/test07-output.txt. Change inputFileName and outputFileName
